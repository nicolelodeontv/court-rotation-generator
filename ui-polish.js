...
const sticky=$('stickyLive');if(sticky){
// Safe observer: scoped only to #stickyLive; fixSticky is idempotent and converges after app render changes.
const obsSticky=new MutationObserver(()=>fixSticky());obsSticky.observe(sticky,{subtree:true,childList:true,characterData:true})}
