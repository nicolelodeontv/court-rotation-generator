const CACHE='crg-clean-v10';
const ASSETS=['./','./index.html','./styles.css?v=crg46','./features.css?v=crg46','./live-ui.css?v=crg5','./scheduler.js?v=crg46','./player-ui.js?v=crg46','./app.js?v=crg46','./live-display.js?v=crg5','./live-skills.js?v=crg3','./features.js?v=crg46','./favicon.svg','./manifest.webmanifest'];
