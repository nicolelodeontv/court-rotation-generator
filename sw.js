const CACHE='crg-facility-v1';
const ASSETS=['./','./index.html','./styles.css','./button-ui-fix.css','./pro-upgrades.css','./facility-upgrades.css','./scheduler.js','./shuffle-fix.js','./pro-bypass.js','./pro-upgrades.js','./pro-hotfix.js','./facility-upgrades.js','./app.js','./favicon.svg'];
