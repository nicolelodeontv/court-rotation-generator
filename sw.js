const CACHE='crg-clean-v4';
const ASSETS=['./','./index.html','./styles.css?v=crg42','./features.css?v=crg42','./live-ui.css?v=crg4','./scheduler.js?v=crg42','./player-ui.js?v=crg42','./app.js?v=crg42','./live-display.js?v=crg4','./features.js?v=crg42','./favicon.svg','./manifest.webmanifest'];
