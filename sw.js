const CACHE='crg-clean-v9';
const ASSETS=['./','./index.html','./styles.css?v=crg45','./features.css?v=crg45','./live-ui.css?v=crg5','./scheduler.js?v=crg45','./player-ui.js?v=crg45','./app.js?v=crg45','./live-display.js?v=crg5','./live-skills.js?v=crg3','./features.js?v=crg45','./favicon.svg','./manifest.webmanifest'];
