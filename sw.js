const CACHE='crg-clean-v3';
const ASSETS=['./','./index.html','./styles.css?v=crg37','./features.css?v=crg37','./scheduler.js?v=crg37','./app.js?v=crg37','./features.js?v=crg37','./favicon.svg','./manifest.webmanifest'];
