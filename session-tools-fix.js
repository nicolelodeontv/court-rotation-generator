...
function boot(){cleanup();new MutationObserver(cleanup).observe(document.body,{subtree:true,childList:true,attributes:true,attributeFilter:['disabled','id','class']})}
